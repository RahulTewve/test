  ...
  <div class="station_inner">
    ...
    <footer class="text-center">
        <div class="footer-above">
            <div class="container">
                <div class="row">
                    <div class="footer-above-inner1 col-md-4 col-sm-12">
                   ...
                   <!-- <div class="footer-above-inner2 col-md-4">
                    ...
                    <div class="footer-above-inner3 col-md-4 col-sm-12">
                    	<div class="col-lg-12">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                    	<div class="col-lg-4"></div>
                        <div class="col-lg-4">Copyright &copy; 2017 Kalayatan Cargo.All rights reserved.</div>
