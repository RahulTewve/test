...
<!--                            <form <?php /*?>action="mail/sendMessage.php" id="contact_form" method="post"<?php */?>>-->
         ...
         <button type="submit" id="submit"  name="submit" class="btn btn-primary mailbutton " style="background-color:#4ab9cf;border-color: #4ab9cf;width:190px;min-height:50px;">SEND MESSAGE </button>
<!--         </form>-->
                ...
                <div class="modal-content">
                    <div class="modal-body popupmodel">
                        <div class="col-lg-12">
                            <button type="button" class="close pull-right" data-dismiss="modal">&times;</button>
                             <div class="form-area">
        <form role="form" action="api/index.php/Welcome/sales" method="post">
        <br style="clear:both">
                    <h3 style="margin-bottom: 25px; text-align: center;">Sales Enquiry</h3>
    				<div class="form-group">
						<input type="text" class="form-control" name="fullname" style="background-color:#eeeeee;" id="Full Name" name="Full Name" placeholder="Full Name" required>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" name="email" style="background-color:#eeeeee;" id="email" name="email" placeholder="Email" required>
					</div>
					<div class="form-group">
						<input type="text" class="form-control" name="number" style="background-color:#eeeeee;" id="mobile" name="mobile" placeholder="Phone Number" required>
					</div>

                    <div class="form-group">
                    <textarea class="form-control" style="background-color:#eeeeee;" name="message" type="textarea" id="message" placeholder="Message" maxlength="140" rows="7"></textarea>
                    </div>

        <button type="submit" id="submit" name="submit" class="btn btn-primary " style="background-color:#4ab9cf;border-color: #4ab9cf;width:190px;min-height:50px;">SEND MESSAGE </button>
        </form>
        </div>
                        </div>
                	</div>
 ...
 <div id="working_on_modal1" class="modal fade" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="form-group">
                ...
                <input type="firstname" class="form-control" id="exampleInputEmail1" name="fullName" placeholder="First Name">
              </div>
             <div class="form-group">
                <label for="exampleInputEmail1">Last Name</label>
                <input type="lastname" class="form-control" id="exampleInputEmail1" name="lastName" placeholder="Last Name">
              </div>
              <div class="form-group">
               ...
               <!-- <input type="address" class="form-control" id="exampleInputEmail1" placeholder="Enter Your Address">-->
                <textarea rows="4" name="address" placeholder="Enter Your Address" name="address" class="form-control"></textarea>
              </div>
              
              <div class="form-group">
                <label for="exampleInputEmail1">Pincode</label>
                <input type="number" class="form-control" id="exampleInputEmail1" name="pincode" placeholder="Pincode" required>
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Enter Description</label>
                <textarea rows="3" name="description" placeholder="Description" name="description" class="form-control" required></textarea>
              </div>
              <button type="submit" id="clicker" class="btn btn-green pull-right">Submit</button>
            </form>
              	</div>
            </div>
          </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                        <form role="form" action="api/index.php/Welcome/contact" method="post">
                           <?php /*?> <form action="mail/sendMessage.php" method="post"><?php */?>
...
//jQuery.noConflict();
  ...
  "url": "http://122.165.117.41/KalayatanMail/api/index.php/Welcome/requestquote",
  "method": "POST",
  "headers": {
