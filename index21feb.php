...
To cultivate a culture of mutual trust and growth for the benefit of all employees of the company</p>
     ...
     <div id="working_on_modal_quote" class="modal fade" role="dialog">
        ...
        <br style="clear:both">
    				...
    				<div class="col-lg-12">
                            <form action="mail/sendMessage.php" id="contact_form" method="post">
                                <input type="text" name="fullName" placeholder="Full Name" class="contact-form-control"/><br/>
                                <input type="text" id="email" name="email" placeholder="Email"  class="contact-form-control"/><br/>
         ...
         <button type="button" id="submit" onclick="myFunction()" name="submit" class="btn btn-primary mailbutton " style="background-color:#4ab9cf;border-color: #4ab9cf;width:190px;min-height:50px;">SEND MESSAGE </button>
                        </div>
